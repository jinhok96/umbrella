...
export const OPEN_WEATHER_ONE_CALL_SERVICE_ERROR_STATUS: OpenWeatherOneCallServiceErrorStatus = {
  '400': {
    ...
    kr: '요청의 일부 필수 파라미터가 누락되었거나, 요청 파라미터의 형식이 잘못되었거나, 값이 허용 범위를 벗어났습니다.',
  },
  '401': {
