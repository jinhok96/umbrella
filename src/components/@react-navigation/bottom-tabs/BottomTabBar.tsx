...
import BottomTabItem from '@components/@react-navigation/bottom-tabs/BottomTabItem';
import { useIsKeyboardShown } from '@hooks/useIsKeyboardShown';

import type { BottomTabBarProps } from '@react-navigation/bottom-tabs';
import type { ParamListBase, TabNavigationState } from '@react-navigation/native';
import type { BottomTabDescriptorMap } from 'node_modules/@react-navigation/bottom-tabs/lib/typescript/src/types';
...
/**
 * `@react-navigation/bottom-tabs`의 `BottomTabBar` 컴포넌트
 *
 * 일부 스타일 제거
 *
 * 테스트 코드 작성 X
      ...
      style={[
        ...
        (
          Platform.OS === 'web'
            ...
            : (direction === 'rtl' && tabBarPosition === 'left') || (direction !== 'rtl' && tabBarPosition === 'right')
        )
                ...
                transform: [
                  {
                    translateY: visible.interpolate({
                      inputRange: [0, 1],
                      outputRange: [
                        layout.height + insets[tabBarPosition === 'top' ? 'top' : 'bottom'] + StyleSheet.hairlineWidth,
                        0,
                      ],
                    }),
                  },
